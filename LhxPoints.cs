...
namespace Kaitai
{
    public partial class LhxPoints : KaitaiStruct
    {
        public static LhxPoints FromFile(string fileName)
        {
            return new LhxPoints(new KaitaiStream(fileName));
        }

        public LhxPoints(KaitaiStream p__io, KaitaiStruct p__parent = null, LhxPoints p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class HeaderInfo : KaitaiStruct
        {
            ...
            public HeaderInfo(KaitaiStream p__io, LhxPoints p__parent = null, LhxPoints p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private LhxPoints m_root;
            private LhxPoints m_parent;
            ...
            public LhxPoints M_Root { get { return m_root; } }
            public LhxPoints M_Parent { get { return m_parent; } }
        }
        public partial class Dotcloud : KaitaiStruct
        {
            ...
            public Dotcloud(KaitaiStream p__io, LhxPoints p__parent = null, LhxPoints p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Dot : KaitaiStruct
        {
            ...
            public Dot(KaitaiStream p__io, LhxPoints.Dotcloud p__parent = null, LhxPoints p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private short _y;
            private LhxPoints m_root;
            private LhxPoints.Dotcloud m_parent;
            public short X { get { return _x; } }
            public short Z { get { return _z; } }
            public short Y { get { return _y; } }
            public LhxPoints M_Root { get { return m_root; } }
            public LhxPoints.Dotcloud M_Parent { get { return m_parent; } }
        }
